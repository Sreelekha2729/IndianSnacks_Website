...
import "./Savoury.css";
import SavouryDisplay from "./SavouryDisplay";
    ...
    <div>
      ...
      >
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../Images/image11.webp" class="d-block" alt="wallpaper" />
            <div class="carousel-caption d-none d-md-block">
              <h6 className="headingColor">Savouries</h6>
              <p>
      ...
      >
        ...
        <div class="offcanvas-body">
          <div>
            Select your favorite Savouries according to the filters given below
      ...
      <div>
        <div>
          <div id="heading1">
            <p> Savouries </p>
            <Link to="./Savouries/Savoury.js" className="linking">
              view all
            </Link>
          </div>

          <div className="container mt-5">
            <SavouryDisplay savouryData={price} />
          </div>
        </div>
      </div>
    </div>
